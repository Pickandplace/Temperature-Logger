...
BYTE LoadMBR(DISK *dsk)
{
    ...
    //if ( MDD_SectorRead( 0x01, dsk->buffer) != TRUE)
    {
        error = CE_BAD_SECTOR_READ;
        ...
        do      //test each possible boot sector (FAT32 can have backup boot sectors)
        {
            ...
            else   
            {
                ...
                do      //loop just to allow a break to jump out of this section of code
                {
                    ...
                    dsk->fat        = dsk->firsts + BSec->FAT.FAT_16.BootSec_ResrvSec;//moi
                   // dsk->fat = 0x00000003;
    ...
    switch (mode)
    {
        ...
        case 1:
            ...
            if ((disk->type == FAT12) || (disk->type == FAT16))
            {
                ...
                gDataBuffer[28] = (BYTE)(disk->firsts & 0xFF);//moi (disk->firsts & 0xFF);
            ...
            *(dataBufferPointer + 511) = 0xAA;
            ...
            if (MDD_SectorWrite (disk->firsts, gDataBuffer, FALSE) == FALSE)//moi
            {
                FSerrno = CE_WRITE_ERROR;
                return EOF;
            }
